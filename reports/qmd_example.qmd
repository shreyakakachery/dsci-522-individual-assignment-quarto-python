...
The Python programming language [@van_rossum_drake_2009]
and the following Python packages were used to perform the analysis: 
pandas [@mckinney_2010], altair [@vanderplas_2018], click [@team_2020], 
as well as Quarto [@allaire_2022]. 
...
![Horse populations for the province with the largest standard deviation](../results/horse_pops_plot_largest_sd.png){#fig-horse-pops-largest-sd width=65%}
